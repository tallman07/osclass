...
<div class="filters">
    <form action="<?php echo osc_base_url(true); ?>" method="get" class="nocsrf">
        ...
        <fieldset>
            <h3><?php _e('Show only', 'bender_purple') ; ?></h3>
            <div class="row">
                <input type="checkbox" name="bPic" id="withPicture" value="1" <?php echo (osc_search_has_pic() ? 'checked' : ''); ?> />
                <label for="withPicture"><?php _e('listings with pictures', 'bender_purple') ; ?></label>
            </div>
        </fieldset>
        <?php } ?>
        ...
        <fieldset>
            <div class="row price-slice">
                <h3><?php _e('Price', 'bender_purple') ; ?></h3>
                <span><?php _e('Min', 'bender_purple') ; ?>.</span>
                ...
                <span><?php _e('Max', 'bender_purple') ; ?>.</span>
        ...
        <?php } ?>
        <div class="actions">
            <button type="submit"><?php _e('Apply', 'bender_purple') ; ?></button>
        </div>
    </form>
    <fieldset>
        <div class="row ">
            <h3><?php _e('Refine category', 'bender_purple') ; ?></h3>
            <?php bender_purple_sidebar_category_search($category['pk_i_id']); ?>
        </div>
    </fieldset>
</div>
</div>