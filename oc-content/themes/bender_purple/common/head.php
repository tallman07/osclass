...
<?php
    $js_lang = array(
        'delete' => __('Delete', 'bender_purple'),
        'cancel' => __('Cancel', 'bender_purple')
    );
...
<script type="text/javascript">
    var bender_purple = window.bender_purple || {};
    bender_purple.base_url = '<?php echo osc_base_url(true); ?>';
    bender_purple.langs = <?php echo json_encode($js_lang); ?>;
    bender_purple.fancybox_prev = '<?php echo osc_esc_js( __('Previous image','bender_purple')) ?>';
    bender_purple.fancybox_next = '<?php echo osc_esc_js( __('Next image','bender_purple')) ?>';
    bender_purple.fancybox_closeBtn = '<?php echo osc_esc_js( __('Close','bender_purple')) ?>';
</script>
