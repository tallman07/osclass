<?php
    ...
    bender_purple_add_body_class('user user-items');
...
<div class="list-header">
    ...
    <h1><?php _e('My listings', 'bender_purple'); ?></h1>
    <?php if(osc_count_items() == 0) { ?>
        <p class="empty" ><?php _e('No listings have been added yet', 'bender_purple'); ?></p>
    <?php } else { ?>
        <div class="actions">
