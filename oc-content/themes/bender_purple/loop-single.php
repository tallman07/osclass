            ...
            <div class="listing-data">
                ...
                <?php if($admin){ ?>
                    <span class="admin-options">
                        ...
                        <span>|</span>
                        <a class="delete" onclick="javascript:return confirm('<?php echo osc_esc_js(__('This action can not be undone. Are you sure you want to continue?', 'bender_purple')); ?>')" href="<?php echo osc_item_delete_url();?>" ><?php _e('Delete', 'bender_purple'); ?></a>
                        <?php if(osc_item_is_inactive()) {?>
                        <span>|</span>
                        <a href="<?php echo osc_item_activate_url();?>" ><?php _e('Activate', 'bender_purple'); ?></a>
                        <?php } ?>
                    </span>
                <?php } ?>
            </div>
